module.exports = {
  ...
  async up(db, client) {
    ...
    try {
      ...
      console.log('Index on userId already exists, skipping...');
    }
    ...
    try {
      ...
      console.log('Unique compound index on (gx, gy) already exists, skipping...');
    }
    ...
    try {
      ...
      console.log('Index on updatedAt already exists, skipping...');
    }
